    ...
    <header>
        <div class="container ">
            <nav class="navbar navbar-expand-md navbar-light bg-light w-100 m-0 p-lg-0 p-md-0 p-4 " role="navigation">
                ...
                <!-- Toggle button -->
                <button class="navbar-toggler navbar-toggler-header" type="button" data-toggle="collapse"
                ...
                <!-- Menu -->
                <div class="collapse navbar-collapse navbar-collapse-header justify-content-end "
                    ...
                    wp_nav_menu(
                        array(
                            ...
                            'depth' => 2,
                            'container' => false,
                            'menu_class' => 'navbar-nav navbar-nav-header m-0 p-0',
